...
<div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <p>If you have an account. Please <Link to="/login" className='text-blue-600 underline hover:text-black'>Login</Link> here</p>
						<div className="relative">
							<button className="bg-blue-500 text-white rounded-md px-6 py-2 hover:bg-black">Sign up</button>
						</div>
					</form>
				</div>
